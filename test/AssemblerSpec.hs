  ...
  describe "runAssembler" $ do
    context "register loading" $ do
      ...
      it "assembles a 'LOAD sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "load" (RegisterOperand Register0) (IdentifierOperand "lorem" (Just InvertModifier))) `shouldReturn` [0x010FE]
        assemble (BinaryInstruction "load" (RegisterOperand Register0) (IdentifierOperand "baz" (Just LowerModifier))) `shouldReturn` [0x010FF]
        assemble (BinaryInstruction "load" (RegisterOperand Register0) (IdentifierOperand "baz" (Just UpperModifier))) `shouldReturn` [0x0100F]
    ...
    context "logical" $ do
      ...
      it "assembles a 'AND sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "and" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x03001]
      ...
      it "assembles a 'OR sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "or" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x05001]
      ...
      it "assembles a 'XOR sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "xor" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x07001]
    ...
    context "arithmetic" $ do
      ...
      it "assembles a 'ADD sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "add" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x11001]
      ...
      it "assembles a 'ADDCY sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "addcy" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x13001]
      ...
      it "assembles a 'SUB sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "sub" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x19001]
      ...
      it "assembles a 'SUBCY sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "subcy" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x1B001]
    ...
    context "test and compare" $ do
      ...
      it "assembles a 'TEST sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "test" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x0D001]
      ...
      it "assembles a 'TESTCY sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "testcy" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x0F001]
      ...
      it "assembles a 'COMPARE sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "compare" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x1D001]
      ...
      it "assembles a 'COMPARECY sX, kk' instruction" $ do
        ...
        assemble (BinaryInstruction "comparecy" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x1F001]
    ...
    context "input and output" $ do
      ...
      it "assembles a 'INPUT sX, pp' instruction" $ do
        ...
        assemble (BinaryInstruction "input" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x09001]
      ...
      it "assembles a 'OUTPUT sX, pp' instruction" $ do
        ...
        assemble (BinaryInstruction "output" (RegisterOperand Register0) (IdentifierOperand "lorem" Nothing)) `shouldReturn` [0x2D001]
    ...
    context "jump" $ do
      it "assembles a 'JUMP aaa' instruction" $ do
        ...
        assemble (UnaryInstruction "jump" (IdentifierOperand "foo" Nothing)) `shouldReturn` [0x22001]
      ...
      it "assembles a 'JUMP Z, aaa' instruction" $ do
        ...
        assemble (BinaryInstruction "jump" (ConditionOperand ZeroCondition) (IdentifierOperand "foo" Nothing)) `shouldReturn` [0x32001]
      ...
      it "assembles a 'JUMP NZ, aaa' instruction" $ do
        ...
        assemble (BinaryInstruction "jump" (ConditionOperand NotZeroCondition) (IdentifierOperand "foo" Nothing)) `shouldReturn` [0x36001]
      ...
      it "assembles a 'JUMP C, aaa' instruction" $ do
        ...
        assemble (BinaryInstruction "jump" (ConditionOperand CarryCondition) (IdentifierOperand "foo" Nothing)) `shouldReturn` [0x3A001]
      ...
      it "assembles a 'JUMP NC, aaa' instruction" $ do
        ...
        assemble (BinaryInstruction "jump" (ConditionOperand NotCarryCondition) (IdentifierOperand "foo" Nothing)) `shouldReturn` [0x3E001]
